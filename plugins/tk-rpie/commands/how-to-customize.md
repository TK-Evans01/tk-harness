...
Create a `.tk-harness/` directory in your project root with these optional files:

### `.tk-harness/design-plan-guidance.md`
...
### `.tk-harness/implementation-plan-guidance.md`
