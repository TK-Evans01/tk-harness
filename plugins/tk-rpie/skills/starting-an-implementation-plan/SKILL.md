...
(conditional) TaskCreate: "Read project implementation guidance from [absolute path]"
  ...
  → (only if .tk-harness/implementation-plan-guidance.md exists)
...
1. **REQUIRED SUB-SKILL:** Use tk-rpie:using-git-worktrees
...
**Check if `.tk-harness/implementation-plan-guidance.md` exists:**

Use the Read tool to check if `.tk-harness/implementation-plan-guidance.md` exists in the session's working directory.

**If the file exists:**

1. Use TaskCreate to add: "Read project implementation guidance from [absolute path to .tk-harness/implementation-plan-guidance.md]"
...
**REQUIRED SUB-SKILL:** Use tk-rpie:writing-implementation-plans
...
cat /path/to/plugins/tk-rpie/skills/starting-an-implementation-plan/SKILL.md
```
...
/tk-rpie:execute-implementation-plan /Users/ed/project/.worktrees/oauth2-feature/docs/implementation-plans/2025-01-17-oauth2-feature/ /Users/ed/project/.worktrees/oauth2-feature/
...
---
Provenance: ported from ed3d-plugins/tk-rpie (CC-BY-SA-4.0); ultimately derived from obra/superpowers (MIT).
