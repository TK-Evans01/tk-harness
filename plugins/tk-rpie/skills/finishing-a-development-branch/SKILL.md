...
Before merging or creating a PR, invoke `tk-rpie:librarian` to update CLAUDE.md files if contracts or structure changed.
...
**If librarian subagent is not available:** skip this step, saying aloud that you're skipping it because the `tk-rpie` plugin is not available.
