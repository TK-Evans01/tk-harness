...
**REQUIRED BACKGROUND:** Read tk-rpie:writing-claude-directives for foundational guidance on token efficiency, compliance techniques, and directive structure (if/when ported).
