...
- (conditional) Read project design guidance (if `.tk-harness/design-plan-guidance.md` exists)
...
**Check if `.tk-harness/design-plan-guidance.md` exists:**

Use the Read tool to check if `.tk-harness/design-plan-guidance.md` exists in the session's working directory.

**If the file exists:**

1. Use TaskCreate to add: "Read project design guidance from [absolute path to .tk-harness/design-plan-guidance.md]"
...
**REQUIRED SUB-SKILL:** Use tk-rpie:asking-clarifying-questions
...
**REQUIRED SUB-SKILL:** Use tk-rpie:brainstorming
...
**REQUIRED SUB-SKILL:** Use tk-rpie:writing-design-plans
...
```
/tk-rpie:start-implementation-plan @docs/design-plans/[full-filename].md .
```
